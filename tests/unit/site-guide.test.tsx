...
describe("the guide's replies", () => {
  ...
  it.each([
    ...
    ["are there any courses I can listen to", "/learn"],
    ["who runs this site", "/about"],
  ...
  it("does not send a worry to the About pages", () => {
    const reply = answerGuide("I'm worried about my pain, why does it hurt");
    expect(reply.links.map((link) => link.href)).not.toContain("/about");
  });
