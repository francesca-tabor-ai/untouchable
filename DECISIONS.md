...
Four everyday trackers now live under `/trackers/…` and are listed on My health → Health tracker,
where PL-66 had them as "not built yet": water, sleep, blood test results, and bowel habits. Their records are held in the browser's local
